...
{
    public class CenterService : BaseService<Center>, ICenterService
    {
        private readonly ISysContext _context;
        private const string TAG = "T";
        public CenterService(ISysContext context) : base(context.CenterRepository)
        {
            _context = context;
        }
        ...
        protected override async Task InitializeInsertModel(Center entity)
        {
            if (entity == null)
            {
                return;
