...
namespace Tenjin.Sys.Services
{
    public class LevelService : BaseService<Level>, ILevelService
    {
        ...
        private const string TAG = "TD";
        public LevelService(ISysContext context) : base(context.LevelRepository)
        {
            _context = context;
        }
        ...
        protected override async Task InitializeInsertModel(Level entity)
        {
            if (entity == null)
            {
                return;
