...
namespace Tenjin.Sys.Services
{
    public class ClassroomService : BaseService<Classroom>,IClassroomService
    {
        ...
        private const string TAG = "L";
        public ClassroomService(ISysContext context) : base(context.ClassroomRepository)
        {
            _context = context;
        }
        ...
        protected override async Task InitializeInsertModel(Classroom entity)
        {
            if (entity == null)
            {
                return;
