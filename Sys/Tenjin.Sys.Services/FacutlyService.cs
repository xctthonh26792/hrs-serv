...
{
    public class FacutlyService : BaseService<Facutly>, IFacutlyService
    {
        private readonly ISysContext _context;

        private const string TAG = "K";
        ...
        protected override async Task InitializeInsertModel(Facutly entity)
        {
            if (entity == null)
            {
                return;
